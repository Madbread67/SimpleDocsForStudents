...
class UniversalDocumentGenerator:
    ...
    def get_all_available_variables(self) -> Dict[str, List[str]]:
        """Получение всех доступных переменных сгруппированных по категориям"""
        return get_variables_by_category()

    def get_flat_variable_list(self) -> List[str]:
        """Получение плоского списка всех доступных переменных"""
    ...
    def prepare_student_data(self, student_data: Dict) -> Dict[str, str]:
        ...
        data = {
            ...
            'Specialnost_id': student_data.get('specialty_code', ''),
